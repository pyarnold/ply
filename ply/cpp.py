...
class Preprocessor(object):
    ...
    def macro_expand_args(self, macro, args):
        ...
        # Make string expansion patches.  These do not alter the length of the
        ...
        # Make the variadic macro comma patch.  If the variadic macro argument
        # is empty, we get rid
        comma_patch = False
                ...
                if name == 'define':
                    ...
                    if ifstack:
                        ...
                        if ifstack[-1][0]:
                            ...
                            if enable:
                                enable = False
                            # If False, but not triggered yet, we'll check
                            # expression
                            elif not iftrigger:
                                result = self.evalexpr(args)
                                if result:
            ...
            if not mtype:
                ...
                for a in args:
                    ...
                    while i < len(mvalue):
                        ...
                        i += 1
                    m = Macro(
                        name.value, mvalue, [x[0].value for x in args], variadic)
